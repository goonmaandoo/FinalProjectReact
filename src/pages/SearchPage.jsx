    ...
    return (
        <main className={styles["main_box"]}>
            <div className={styles["main_container"]}>
                <div className={styles["keyword_result"]}>"{keyword}"에 대한 검색결과</div>
                <hr />
                                        ...
                                        <div className={styles["search_result"]}>
                                            ...
                                            <div className={styles["search_store_detail"]}>
                                                <div>
                                                    ...
                                                    <div className={styles["search_menu_name"]}>{item.storeName}</div>
                                                    <div className={styles["search_menu_price"]}>{item.menuPrice}원</div>
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
                                        ...
                                        <div className={styles["search_result"]}>
                                            ...
                                            <div className={styles["search_store_detail"]}>
                                                <div>
                                                    ...
                                                    <div className={styles["search_menu_name"]}>{item.roomAddress}</div>
